...
#define PROGRESS_HEIGHT 4.0
#define THUMB_IMAGE_HEIGHT 18.0
...
#pragma mark addTarget: action: forControlEvents:添加的事件，被触发时会回调这个方法，此方法可以拦截事件;sendActionsForControlEvents:则会立刻回调这个方法。
...
- (void)loadView
{
    ...
    _minimumTrackTintColor = Color_Main_99CC33;//[UIColor blueColor];
